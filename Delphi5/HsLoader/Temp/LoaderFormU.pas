...
function TLoaderForm.CheckUpdate(ExeName, Version: string;UpdaterFileDate: TDatetime): Boolean ;
var
...
procedure TLoaderForm.AddEvent(EventName, FileName, Note: string) ;
begin
  try
    Append(LogFile) ;
